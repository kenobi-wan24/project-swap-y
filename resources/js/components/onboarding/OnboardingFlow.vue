    ...
    <div style="flex:1;display:flex;align-items:center;justify-content:center;overflow:hidden;">
        <transition name="step" mode="out-in">
            ...
            >
                ...
                <div style="margin-bottom:36px;">
                    ...
                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;">
                        <div
                            ...
                            style="position:relative;border-radius:14px;padding:18px 14px;cursor:pointer;transition:all .2s;"
                            :style="{
                ...
                <button
                    @click="goNext"
                    style="width:100%;padding:17px;background:#ED730C;color:#fff;font-size:1rem;font-weight:700;border:none;border-radius:14px;cursor:pointer;font-family:'DM Sans',sans-serif;transition:background .15s;"
            ...
            >
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:36px;">
                    ...
                    >
                        <div v-if="intent === 'post'" style="position:absolute;top:14px;right:14px;width:22px;height:22px;background:#ED730C;border-radius:50%;display:flex;align-items:center;justify-content:center;">
                    ...
                    >
                        <div v-if="intent === 'explore'" style="position:absolute;top:14px;right:14px;width:22px;height:22px;background:#ED730C;border-radius:50%;display:flex;align-items:center;justify-content:center;">
                            <svg width="11" height="11" viewBox="0 0 12 10" fill="none">
                                <path d="M1 5l3.5 3.5L11 1" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                ...
                <div style="margin-top:18px;">
                    <button
                        ...
                        style="font-size:0.875rem;font-weight:600;color:#9ca3af;background:none;border:1.5px solid #e5e7eb;border-radius:10px;padding:11px 28px;cursor:pointer;font-family:'DM Sans',sans-serif;"
