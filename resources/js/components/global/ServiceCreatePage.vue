    ...
    <div style="max-width:640px;margin:0 auto;padding:28px 24px 120px;">
      ...
      <div v-else-if="currentStep === 2">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
          <div>
            <label for="sv-rate" style="font-size:0.65rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#5c5751;display:block;margin-bottom:6px;">Rate (₱) <span style="color:#9ca3af;font-weight:400;text-transform:none;letter-spacing:0;">(optional)</span></label>
