  ...
  <section v-if="featuredSellers.length" class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/garage-sale/section/featured" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/garage-sale/section/popular" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section v-if="nearbyCitySellers.length" class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/garage-sale/section/nearby" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/garage-sale/section/near-you" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
