  ...
  <section v-if="featuredHomes.length" class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/homes/section/featured" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/homes/section/popular" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section v-if="nearbyCityHomes.length" class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/homes/section/nearby" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
  ...
  <section class="scroll-section">
    <div class="section-inner">
      <div class="section-header">
        ...
        <a href="/homes/section/near-you" class="see-all">See all →</a>
      </div>
      <div class="hscroll">
